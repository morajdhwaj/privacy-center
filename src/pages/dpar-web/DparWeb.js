...
const header = [
  {
    ...
    data: [
      {
        heading1: "Welcome to Concur Privacy Webform!",
        heading2: "Thank you.",
        ...
        desc1:
          "You can use this form to submit a request regarding your personal information that is processed by Concur and its subsidiaries and affiliates (Convercent by Concur, Concur DataGuidance, Planetly by Concur, PrivacyConnect, Redacted.ai, and Tugboat Logic by Concur). Please complete this form and we will respond as soon as possible.",
        desc2:
        ...
        desc3:
          "Concur and its subsidiaries and affiliates can only action requests from individuals with a direct relationship to Concur or its subsidiaries and affiliates. This includes requests from our customers, job applicants, employees or marketing recipients.",
        desc4:
        ...
        desc5:
          "If you are looking to make a request to a company that uses Concur to manage their privacy, security, or third party risk programs, please directly do so on their website",
        desc6:
          "Trimtab Innovation Pvt Ltd. 701, The Capital, Bandra Kurla Complex Bandra(East), Mumbai, India, 450001",
        countries: [
          {
            id: "option-0",
            text: "India",
        ...
        entities: [
          ...
          {
            id: "option-1",
            text: "Convercent by Concur",
          },
          {
            id: "option-2",
            text: "Planetly by Concur",
          },
          {
            id: "option-3",
            text: "Tugboat Logic by Concur",
          },
          {
            id: "option-4",
            text: "DataGuidance",
    ...
    data: [
      {
        ...
        desc6:
          "  नेट्रस्ट एलएलसी - 1200 एबरनेथी रोड एनई, अटलांटा, जीए 30328, यू.एस.ए. वनट्रस्ट टेक्नोलॉजी लिमिटेड - 82 सेंट जॉन सेंट, फ़ारिंगडन, लंदन, ईसी 1एम 4जेएन, यू.के. हमसे dpo@Concur.com पर संपर्क करें गोपनीयता सूचना",
        countries: [
          {
            id: "option-0",
            text: "भारत",
